...
public class ColiAdapter extends RecyclerView.Adapter {
    private Context mContext;
    private ArrayList<DbBean> list;

    public ColiAdapter(Context mContext, ArrayList<DbBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        listItem.home_te.setText(list.get(position).getName());
        Glide.with(mContext).load(list.get(position).getUrl()).into(listItem.home_img);
